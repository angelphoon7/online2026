...
export const ALLOWANCE_NOTE = 'Confirm the USDC approval if prompted, then sign and submit your intent in your wallet. Approval does not reserve funds.';
...
export const DEMO_PRICE_NOTE = 'Each section upgrade adds 0.01 USDC per ticket; each downgrade subtracts 0.01 USDC. The difference in demo reference prices is automatically included as your signed payment limit.';
...
export const STEPS = ['Ticket Preferences', 'Which tickets do you have?'] as const;
